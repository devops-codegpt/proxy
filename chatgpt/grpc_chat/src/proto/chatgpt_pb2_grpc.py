...
from proto import chatgpt_pb2 as proto_dot_chatgpt__pb2
...
class ChatgptStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Send = channel.unary_stream(
                ...
                response_deserializer=proto_dot_chatgpt__pb2.Answer.FromString,
                )
...
def add_ChatgptServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Send': grpc.unary_stream_rpc_method_handler(
                    ...
                    response_serializer=proto_dot_chatgpt__pb2.Answer.SerializeToString,
            ),
    }
...
class Chatgpt(object):
    ...
    def Send(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/openai.Chatgpt/Send',
            ...
            proto_dot_chatgpt__pb2.Answer.FromString,
